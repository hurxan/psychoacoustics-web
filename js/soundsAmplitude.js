...
function select(button) {
    ...
    if (countRev == reversals + secondReversals) {
        ...
        location.href = "php/saveData.php?result=" + result + "&timestamp=" + timestamp + "&type=amp" + description + "&currentBlock=" + currentBlock + "&score=" + score + "&geometric_score=" + geometric_score +  "&saveSettings=" + saveSettings;
    }
