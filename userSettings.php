                ...
                <div class="row row-cols-1 row-cols-lg-2 g-3 justify-content-center align-items-center">
                    ...
                    <div class="col">
                        <div class="input-group">
                            ...
                            <span class="input-group-text form-control overflow-scroll link" id="link" onclick="copy('link')" title="click to copy">psychoacoustics.dpg.psy.unipd.it/sito/demographicData.php?ref=<?php echo $ref; ?></span>
                        </div>
                    </div>
                    <div class="col">
